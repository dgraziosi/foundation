...
The operator is the human who runs Compose. Do not call the graph “the Vault.” Life data stays in the vault, not in git.
...
The mail and calendar the operator attached. Vault MCP at `http://127.0.0.1:8787/mcp` to read due dates.
