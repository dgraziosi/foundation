...
export const ADVERTISED_MCP_TOOLS: readonly AdvertisedMcpTool[] = [
  ...
  },
  {
    ...
    purpose:
      "Create typed edges after validation. One edge or `edges[]` (1–20). Whole batch validates; one transaction writes all or none. Requires endpoint if-match.",
