...
The operator can run this report, or attach it to Vault Keeper ([`AGENTS.md`](./AGENTS.md)). Skill: [`skills/graph-hygiene/`](../skills/graph-hygiene/).
...
- **Not applying product updates.** Git pull + compose rebuild is [`skills/update-foundation/`](../skills/update-foundation/).
