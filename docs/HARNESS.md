...
Health: `GET http://127.0.0.1:8787/health`. Window: `http://127.0.0.1:8788/view` (same API key; unlock, then Home, search, recents, type views). From another machine on this vault: `http://<this-host>:8788/view`.
