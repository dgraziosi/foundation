...
Health: `GET http://127.0.0.1:8787/health`. Window: `/view` on this process (same API key; unlock, graph, search, recents, tasks, inspector). Works from another machine on this vault.
