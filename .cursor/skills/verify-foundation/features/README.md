...
- Verification runs use `.cursor/skills/verify-foundation/scripts/verify-foundation.sh launch` so the data dir is disposable. Do not invent a live personal vault. Do not seed a fake life.
