...
Out of the box: morning brief; capture (what you dump lands in the vault). When you want another seat, it uses [`skills/create-bot/`](skills/create-bot/) and the blank template in that folder.
