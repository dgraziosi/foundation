...
export function resolveBindValue(node: TypeViewNode, fields: readonly TypeField[], bind: ViewBind): string | undefined {
  if (bind === "updated_at") {
...
export function boardColumnIds(
  fields: readonly TypeField[],
  view: ViewDeclaration,
  options: { showCompleted?: boolean; nodes?: readonly TypeViewNode[] } = {},
): string[] {
